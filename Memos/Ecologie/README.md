...
Dans l'optique d'aider nombreux d'entre-vous a connaitre les tenants et aboutissants de l'ecologie, j'ai realise ce guide pour vous aider a comprendre le fonctionnement des Bonus de territoires et le pourquoi on perd ou gagne des points de citoyenete lorsque l'on interagit avec les ressources de l'eco-systeme.

# I. LES BONUS DE TERRITOIRES

Il existe 3 niveaux de bonus de territoires, nous verrons plus tard comment les gerer.

> Note : Pour ouvrir la fenetre de l'ecologie, vous pouvez utiliser la touche `W` qui est le raccourcis par defaut.

## 1.1 - Malus ecologique
...
Maintenant, la question est : Comment savoir quelles ressources impactent le territoire?
...
Une fois que l'on sait quelles ressources il faut respecter. Il suffit de les equilibrer.

## 3.1 Sur/Sous-population

En premier lieu, il est bien entendu important de faire attention a ne pas desequilibrer la zone lorsque celle-ci est deja en equilibre. En faisant cela, en fonction des lois appliquees dans la nation en question, vous perdrez des points de citoyenete et pouvez a partir de **-50** pdc (points de citoyenete) devenir hors la loi et vous faire aggresser par un citoyen de la nation detentrice du territoire.
...
Pour reequilibrer la quantite de bonus, il faut retablir la quantite de celle-ci pour qu'elle soit comprise entre la valeur minimale et maximale indiquee. En faisant cela, en fonction des lois appliquees dans la nation en question, vous gagnerez des points de citoyenete.
...
Une fois le bonus retabli, la jauge passe au vert et l'etoile de satisfaction change d'etat et reapparait en haut de l'interface. Il n'est desormais plus possible de gagner des points de citoyenete, les ressources etant reequilibrees.
...
J'espere que ce guide vous auras plus et merci pour votre attention. 🥰
